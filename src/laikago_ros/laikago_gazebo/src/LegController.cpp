...
void LegController::updateCommand(){
    ...
    for (int i = 0; i <4; i++){
        ...
        //std::cout << "footForce1" << footForce << std::endl;
        ...
        //std::cout << "footForce2" << footForce << std::endl;
        // torque
        ...
        for (int j = 0; j<3; j++){
            ...
            lowCmd.motorCmd[i*3+j].position = commands[i].qDes(j);
            lowCmd.motorCmd[i*3+j].velocity = commands[i].qdDes(j);
            lowCmd.motorCmd[i*3+j].positionStiffness = commands[i].kpJoint(j,j);
            lowCmd.motorCmd[i*3+j].velocityStiffness = commands[i].kdJoint(j,j);
            
         //std::cout << "motor torque cmd: " << lowCmd.motorCmd[i*3+j].torque << std::endl;
         //std::cout << commands[i].tau(j) << std::endl;
         //std::cout << "motor torque cmd: " << lowCmd.motorCmd[i*3+j].torque << std::endl;
         //std::cout << "position cmd: " << lowCmd.motorCmd[i*3+j].position << std::endl;
         //std::cout << "velocity cmd: " << lowCmd.motorCmd[i*3+j].velocity << std::endl;
...
void LegController::updateCommand_Jump2D(){
    ...
    for (int i = 0; i <4; i++){
        ...
        //commands[i].tau = Vec3<double>::Zero();
        Vec3<double> legTorque = commands[i].tau;
        std::cout << "commmand tau des" << commands[i].tau << std::endl;
        // forceFF

        Vec3<double> footForce = commands[i].feedforwardForce;
        std::cout << "footForce from QP: " << footForce << std::endl;
        ...
        //std::cout << data[i].J << std::endl;
        commands[i].tau = legTorque;
        //std::cout << "commmand tau" << commands[i].tau << std::endl;
        for (int j = 0; j<3; j++){
            lowCmd.motorCmd[i*3+j].torque = commands[i].tau(j);
            lowCmd.motorCmd[i*3+j].position = commands[i].qDes(j);
            lowCmd.motorCmd[i*3+j].velocity = commands[i].qdDes(j);
...
void LegController::updateCommand_Jump3D_5base(){
