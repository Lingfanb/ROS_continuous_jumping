...
void update_problem_data(double* p, double* v, double* q, double* w, double* r, double pitch, double* weights, double* state_trajectory, double alpha, int* gait, double* ref_contact)
{
...
// void update_problem_data_jump(double* p, double* v, double* q, double* w, double* r, double yaw, double* weights, double* state_trajectory, double alpha, double* gjump)
// {
//   mfp_to_flt(update.p,p,3);
//   mfp_to_flt(update.v,v,3);
//   mfp_to_flt(update.q,q,4);
...
//   //are called from the same thread
//   mfp_to_flt(update.traj,state_trajectory,12*problem_configuration.horizon);
//   mfp_to_flt(update.gj,gjump,4*problem_configuration.horizon);
//   update.alpha = alpha;
//   solve_mpc(&update, &problem_configuration);
//   has_solved = 1;
// }
