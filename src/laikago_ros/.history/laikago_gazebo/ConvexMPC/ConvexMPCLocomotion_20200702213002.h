...
public:
  ...
  bool getFlightPhase(); // 1 for flight phase, 0 for stance phase
  int* mpc_gait();
...
public:
  ...
  void bounding(ControlFSMData& data);
...
private:
  ...
  void updateMPCBounding(int* mpcTable, ControlFSMData& data, bool flight); 
  ...
  Gait trotting, bounding, pacing, walking, galloping, pronking, bounding_op;
  ...
  // for posture Adjustment on Sloped Terrain
