...
plot_hip_torque_cmd('joint_des.txt', 'command hip torque')
plot_thigh_torque_cmd('joint_des.txt', 'command thigh torque')
plot_calf_torque_cmd('joint_des.txt', 'command calf torque')
