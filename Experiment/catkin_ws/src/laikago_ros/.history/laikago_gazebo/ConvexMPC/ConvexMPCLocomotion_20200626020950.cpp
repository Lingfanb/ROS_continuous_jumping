...
void ConvexMPCLocomotion::updateMPCIfNeeded(int* mpcTable, ControlFSMData& data, bool omniMode) 
{
  ...
  if((iterationCounter % iterationsBetweenMPC) == 0)
  {
   // std::cout << "runMPC" << std::endl;
    ...
    double Q[12] = {0.25, 0.25, 10, 2.5, 2.5, 10, 0, 0, 0.3, 0.2, 0.2, 0.2};
    ...
    update_solver_settings(1 /*_parameters->jcqp_max_iter*/,5e-8 /* _parameters->jcqp_rho */,
      1e-8 /*_parameters->jcqp_sigma*/, 1 /* _parameters->jcqp_alpha*/, 1 /*_parameters->jcqp_terminate*/,1/* _parameters->use_jcqp*/);
