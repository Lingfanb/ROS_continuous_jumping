...
#------------------Command torque----------------------------
def plot_hip_torque_cmd(file_name, title): # tau_ff, q_des , q_act, dq_des, dq_act
    data= np.genfromtxt(file_name, delimiter=' ')
    tau_0 = data[:,][:,24]
    tau_1 = data[:,][:,25]
    tau_2 = data[:,][:,26]
...
def plot_thigh_torque_cmd(file_name, title):
    data= np.genfromtxt(file_name, delimiter=' ')
...
def plot_calf_torque_cmd(file_name, title):
    data= np.genfromtxt(file_name, delimiter=' ')
...
#--------------------------------------------------------------------
def plot_thigh_torque_comparison_total_feedback(file_name_1, file_name_2,title):
    # file_name_1: torque.txt, to get total torque
    # file_name_2: joint_act.txt, to get feedback
    ...
    t = np.linspace(0,f1_2.shape[0],f1_2.shape[0])

    fig, ax = plt.subplots()
    #ax.plot(t, f1_0, label='FR_tt') # 
    #ax.plot(t, f1_1, label='FL_tt') # 
    ax.plot(t, f1_2, label='RR_tt') # 
    #ax.plot(t, f1_3, label='RL_tt') # 
    #ax.plot(t, f2_0, label='FR_fb') # 
    #ax.plot(t, f2_1, label='FL_fb') # 
    ax.plot(t, f2_2, label='RR_fb') # 
    #ax.plot(t, f2_3, label='RL_fb') # 
...
def plot_calf_torque_comparison_total_feedback(file_name_1, file_name_2,title):
    # file_name_1: torque.txt, to get total torque
    # file_name_2: joint_act.txt, to get feedback
...
def plot_thigh_torque_comparison_feedforward_feedback(file_name_1, file_name_2,title):
    # file_name_1: torque.txt, to get feedforward torque
    # file_name_2: joint_act.txt, to get feedback
    ...
    fig, ax = plt.subplots()
    ax.plot(t, f1_0, label='FR_ff') # 
    #ax.plot(t, f1_1, label='FL_ff') # 
    ax.plot(t, f1_2, label='RR_ff') # 
    #ax.plot(t, f1_3, label='RL_ff') # 
    ax.plot(t, f2_0, label='FR_fb') # 
    #ax.plot(t, f2_1, label='FL_fb') # 
    ax.plot(t, f2_2, label='RR_fb') # 
    #ax.plot(t, f2_3, label='RL_fb') # 
...
def plot_calf_torque_comparison_feedforward_feedback(file_name_1, file_name_2,title):
    # file_name_1: torque.txt, to get feedforward torque
    # file_name_2: joint_act.txt, to get feedback
...
#plot_hip_torque_cmd('joint_des.txt', 'ref hip torque')
#plot_thigh_torque_cmd('joint_des.txt', 'ref thigh torque')
#plot_calf_torque_cmd('joint_des.txt', 'ref calf torque')

plot_thigh_torque_comparison_total_feedback('torque.txt','joint_act.txt','thigh torque comparison tt and fb')
plot_calf_torque_comparison_total_feedback('torque.txt','joint_act.txt','calf torque comparison tt and fb')
plot_thigh_torque_comparison_feedforward_feedback('torque.txt','joint_act.txt','thigh torque comparison ff and fb')
plot_calf_torque_comparison_feedforward_feedback('torque.txt','joint_act.txt','calf torque comparison ff and fb')
plt.show()
