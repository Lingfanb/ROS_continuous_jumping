...
class FSM_State{
  public:
    ...
    void Jump_MPC_testPSU(); // jump with MPC with external PSU

    void Jump2D(); // jump in 2D
    void JointPD_Stand(); // Standing by joint PD
    void Successive_jumping();
    ...
    // boolean for the controller
    bool runQP = true;
    bool boolean_readref = true;
    bool boolean_runPD = true;
    bool boolean_runMPC = false;
    bool boolean_runwhichjump = true;
    bool boolean_changeref = false;
    bool boolean_runPDnewref = false;
    bool boolean_runcartesianPD = false;
    bool boolean_runPD_flightphase = true;
