...
EXTERNC void update_problem_data(double* p, double* v, double* q, double* w, double* r, double pitch, double* weights, double* state_trajectory, double* force_ref, double alpha, double* ref_contact); // chuong add
...
// EXTERNC void update_problem_data_jump(double* p, double* v, double* q, double* w, double* r, double yaw, double* weights, double* state_trajectory, double alpha, double* gjump);
...
//                                         float* state_trajectory, float alpha, int* gait);           // original                             
#endif