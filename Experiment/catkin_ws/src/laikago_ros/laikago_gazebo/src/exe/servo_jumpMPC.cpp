...
//#include "../../include/FSM_Jump.h" // chuong add
...
int main(int argc, char **argv)
{
  ...
  /*!  ros::AsyncSpinner spin(1);
    ...
    */
    ...
    // stateEstimator->run();
    // fsm->Jump_MPC(); // MPC locomotion implemented in this function
    fsm->Successive_jumping();
    // fsm->Jump_MPC_testPSU(); // MPC locomotion implemented in this function
    //fsm->Jump2D(); // Jump2D with QP landing controller
    // fsm-> Jump3D_1roll(); // Jump3D left with QP landing controller
    //fsm-> JointPD_Stand();
    //fsm ->QPstand();
    //fsm -> PDstand();
